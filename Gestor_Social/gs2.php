...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item active">
      <a type="button" href="gs.php" class="btn btn-primary btn-sm">GESTOR SOCIAL</a>
      </button>
    </li>&nbsp
    <li class="nav-item active">
...
<!-- FIN HEADER -->
  <div class="jumbotron">
  <a class="btn btn-primary btn-lg" href="index.php" role="button">Volver a la pagina principal</a>
  <hr class="my-4">
  <h1 class="display-4">Anuncios:</h1>
  <p class="lead">Eventos y Noticias</p>
  <div style="text-align: right;width: 1400">
  <a class="btn btn-primary btn-lg" href="crearnoticia.php" role="button">Subir Noticia</a><br><br>
  </div>
  <br><br>
  <center>
  <img src="noticia4.jpg" align="center" width="150" height="150" style='width:933px; height:1334px'> <br><br>
  </center>
  <center>
  <img src="noticia5.png" align="center" width="150" height="150" style='width:933px; height:1154px'> <br><br>
  </center>
  <center>
  <img src="noticias6.jpg" align="center" width="150" height="150" style='width:933px; height:440px'> <br><br>
  </center>
  
  <center>
  <a class="btn btn-primary btn-lg" href="gs.php" role="button">Pagina anterior</a>
  <a class="btn btn-primary btn-lg" href="gs3.php" role="button">Siguiente pagina</a>
  </center>
</div>
