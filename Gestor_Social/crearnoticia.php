...
<!-- FIN HEADER -->
  ...
  <hr class="my-4">
  <center>
  <h1 class="display-4">Administrador de noticias</h1>
  <p class="lead">Aqui podra Crear, Editar o Borrar noticias</p>

  <a href="crear.php" class="btn btn-outline-success btn-lg"> Crear Noticia</a> 
  <a href="" class="btn btn-outline-warning btn-lg"> Editar Noticia</a> 
  <a href="" class="btn btn-outline-danger btn-lg"> Eliminar Noticia</a> 
  </center>
</div>
